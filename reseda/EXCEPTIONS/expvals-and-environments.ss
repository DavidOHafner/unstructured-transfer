...
;;; Expressed values and environments for EXCEPTIONS
...
;;; for expressed values of the EXCEPTIONS programming language,
...
(define-library (EXCEPTIONS expvals-and-environments)
  (export expval? num-val bool-val proc-val list-val expval->num
          expval->bool expval->proc expval->elements proc? a-proc
          environment? empty-env extend-env extend-env-rec apply-env
          init-env)
  (import (scheme base)
          (utilities eopl)
  ...
  (begin
    ...
    ;; An expressed value in EXCEPTIONS
    ;; is either an exact integer, a Boolean,
    ;; or a value of the proc (i.e., closure) data type defined below,
    ;; or a list of expressed values.
    ...
    ;; EXCEPTIONS programs are evaluated
