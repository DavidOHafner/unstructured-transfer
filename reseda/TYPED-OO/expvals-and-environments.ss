...
;;; Expressed values and environments for TYPED-OO
...
;;; for expressed values of the TYPED-OO programming language,
...
(define-library (TYPED-OO expvals-and-environments)
  ...
  (begin
    ...
    ;; An expressed value in TYPED-OO
   ...
   ;; expval->obj : ExpVal -> Object
    ...
    ;; TYPED-OO programs are evaluated
    ...
    ;; because in TYPED-OO the class at the root of the hierarchy
    ;; has no methods.)
